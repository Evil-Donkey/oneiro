        ...
        <div className={`${lightBackground ? `bg-white-01` : `bg-blue-02`} py-20`}>
            <div className="container mx-auto relative px-6 md:px-4">
                <div className="overflow-hidden rounded-lg">
                    <LazyItem>
                        {image && <Image className={`${mobileImage ? `hidden md:block` : ``}`} src={image.mediaItemUrl} alt={image.altText} width={image.mediaDetails.width} height={image.mediaDetails.height} />}
