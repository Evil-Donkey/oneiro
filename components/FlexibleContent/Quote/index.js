    ...
    return (
        <div className={`${styles.quote} bg-white-01 lg:text-white`}>
            <div className='container mx-auto relative px-6 md:px-4'>
                <div className={`${styles.quoteContent} flex flex-col md:flex-row justify-end p-5 lg:p-20 bg-grey-03 rounded-lg space-x-10 bg-cover bg-left lg:min-h-200 relative overflow-hidden`} style={{ backgroundImage: `url(${image.mediaItemUrl})` }}>
